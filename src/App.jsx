      ...
      <html lang="pt-BR">
        <head>
          ...
          <style>
            ...
            .header img { width: 260px; height: 78px; object-fit: contain; }
      ...
      <html lang="pt-BR">
        <head>
          ...
          <style>
            ...
            .header img { width: 260px; height: 82px; object-fit: contain; }
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .logo { width: 240px; height: 74px; object-fit: contain; }
          ...
          {activeTab === 'relatorios' && (
            <div className="space-y-6 mb-8">
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-5 flex items-center gap-4">
                <img src="/logo-rjlima.svg" alt="Logo RJLima Transportes e Logística" className="h-20 w-auto max-w-[320px] rounded-xl object-contain" />
                <div>
